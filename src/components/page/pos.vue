      ...
      <el-col :span='7' class='pos-order' id='order-list'>
        <el-tabs>
          <el-tab-pane label="点餐">
            ...
            <div class="totalDiv">
                <small>数量</small><strong>{{totalCount}}</strong>&nbsp;&nbsp;&nbsp;
                <small>总计</small><strong>{{totalMoney}}</strong>元
            </div>
            <div class="div-btn">
...
export default {
    ...
    methods: {
        ...
        // 删除所有商品
        delAllGoods() {
            if(this.totalCount>0 && confirm("确定要删除所有商品吗？")) {
                this.tableData = [];
                this.totalCount = 0;
                this.totalMoney = 0;
            }
        ...
        checkOut() {
            if(this.totalCount !== 0) {
                let allMoney = this.totalMoney;
                this.tableData = [];
                this.totalCount = 0;
                this.totalMoney = 0;
                this.$message({
                    message: "结账成功！本次结算金额为" + allMoney +"元",
                    type: "success"
                })
            }else {
                this.$message.error("没有选中商品，不能空结！");
            }
        }
    }
}
